        ...
        <Row>
            <Card v-show="currentIndex === 1">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">三级分销商管理</span>
                    <top-btn
                            :btn-list="btnList"
            ...
            <Card v-show="currentIndex === 12 || currentIndex === 13">
                <p slot="title" class="slot_title_height">
                    <span v-if="currentIndex === 12" class="title_span">新增三级分销商</span>
                    <span v-if="currentIndex === 13" class="title_span">修改三级分销商</span>
                </p>
                <detail-form-area
            ...
            <Card v-show="currentIndex === 14">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">查看三级分销商</span>
                </p>
                <view-del-detail
