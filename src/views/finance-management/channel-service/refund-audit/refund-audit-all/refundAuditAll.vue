        ...
        <Row>
            <Card v-show="currentIndex === 1" :style="{minWidth:'1500px'}">
                <p slot="title" style="height:32px;">
                    <span style="display:inline-block;float:left;line-height:32px;">全部</span>
                    <top-btn
                            :btnList="btnList"
                    ></top-btn>
                </p>
        ...
        return {
            ...
            colname: [
                ...
                },
                {
                    title: '退款状态',
                    render: (h, params) => {
                        return h('div', this.$vfilters.tuikuanStatusFilter(params.row.status));
                    },
                    width: 135
                },
                {
                ...
                },
                {
                    title: '审批时间',
                    render: (h, params) => {
                        return h('div', this.$common.getCurrentDate(params.row.auditDate));
                    },
                    width: 120
                },
                {
            ...
            formItemList: [
                ...
                {
                    type: 4,
                    keyName: 'refundStatus',
                    label: '退款状态',
                    labelWidth: 80,
                    optionList: totalList.tuikuanStatusList
                }
            ],
            pars: {
                formDatas: {
