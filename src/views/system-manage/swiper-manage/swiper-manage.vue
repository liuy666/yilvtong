    ...
    <div>
        <Row>
            ...
            <Card v-show="currentIndex === 12 || currentIndex === 13">
                <p slot="title" class="slot_title_height">
                    <span v-if="currentIndex === 12" class="title_span">新增轮播信息</span>
                    <span v-if="currentIndex === 13" class="title_span">修改轮播信息</span>
                </p>
                <detail-form1
                        ref = "swiper"
                        :isListPage = "false"
            ...
            <Card v-show="currentIndex === 14">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">查看轮播信息</span>
                </p>
                <view-del-detail
                        :isClose = "isClose"
            ...
            return {
                ...
                formItemList_add: [
                    ...
                    },
                    {
                        ...
                        hasDec: '*注：图片标准尺寸1903x470 （同等比例下的大尺寸图片也可以）',
                        isRedDec: true
                    },
                ],
                formDatas_view: {},
        ...
        methods: {
            ...
            refreshUrlQuery () {
                this.urlQuery = {
                    ...
                    type: this.pars.type,
                    // category: this.pars.formDatas.category,
            ...
            async setAddInitData (type) {
                ...
                this.$refs.swiper.$refs.UE[0].setUEContent('');
                this.formDatas_add = {
                ...
                this.$http(`${this.baseUrl}/ec/resourceManager/v1/viewResourceManagerTab`, {
                    ...
                    if (res.data.code === 200) {
                        if (isView) {
                            ...
                            this.$set(this.formDatas_add, 'category', '01');
                            this.formDatas_add.icompanyinfoid = parseInt(this.formDatas_add.icompanyinfoid);
                            this.$refs.swiper.$refs.UE[0].setUEContent(this.formDatas_add.logoMark || '')
                        }
                    } else {
            ...
            async getFormDataAdd (obj) {
                ...
                let aaa = '';
                this.formDatas_add.logoMark = this.$refs.swiper.$refs.UE[0].getUEContent();
