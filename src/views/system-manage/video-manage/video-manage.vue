        ...
        <Row>
            <Card v-show="currentIndex === 1">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">视频管理</span>
                    <top-btn
                            :btnList="btnList"
            ...
            <Card v-show="currentIndex === 12 || currentIndex === 13">
                <p slot="title" class="slot_title_height">
                    <span v-if="currentIndex === 12" class="title_span">新增视频信息</span>
                    <span v-if="currentIndex === 13" class="title_span">修改视频信息</span>
                </p>
                <detail-form1
                        ref = "video"
                        :isListPage = "false"
            ...
            <Card v-show="currentIndex === 14">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">查看视频信息</span>
                </p>
                <view-del-detail
                        :isClose = "isClose"
    ...
    export default {
        ...
        methods: {
            ...
            async setAddInitData (type) {
                ...
                this.$refs.video.$refs.UE[0].setUEContent('');
                this.formDatas_add = {
                ...
                this.$http(`${this.baseUrl}/ec/resourceManager/v1/viewResourceManagerTab`, {
                    ...
                    if (res.data.code === 200) {
                        if (isView) {
                            ...
                            this.$refs.video.$refs.UE[0].setUEContent(this.formDatas_add.logoMark || '')
                        }
                    } else {
            ...
            async getFormDataAdd (obj) {
                ...
                let aaa = '';
                this.formDatas_add.logoMark = this.$refs.video.$refs.UE[0].getUEContent();
