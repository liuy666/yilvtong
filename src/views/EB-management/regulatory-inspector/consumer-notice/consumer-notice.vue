        ...
        <Row>
            <Card v-show="currentIndex === 1">
                <p slot="title" class="slot_title_height">
                    <span class="title_span">消费通知查询</span>
                    <top-btn
                            :btnList="btnList"
    ...
    export default {
            ...
            return {
                ...
                colname:[
                    ...
                    },
                    {
                        title: '更新时间',
                        render: (h, params) => {
                            return h('span', `${this.$common.getCurrentDate(params.row.updateTime)} ${this.$common.getCurrentTime(params.row.updateTime)}`)
                        }
                    },
                    {
                        title: '操作',
        ...
        methods: {
            ...
            changePage(pageCode) {
                ...
                this.$common.currentPageData(this.baseUrl+'/ec/orderNotify/v1/consume/page', this, 'get');
            },
            ...
            async changeModal (e) {
                if (e) {
                    ...
                    this.tipName = '重置消费通知';
                    const aaa = await this.$common.editData(`/ec/orderNotify/v1/consume/reset?id=${this.dialogFormDatas.id}`, this, {}, 'get', true);
                    if (aaa) this.$common.currentPageData(this.baseUrl+'/ec/orderNotify/v1/consume/page', this, 'get')
