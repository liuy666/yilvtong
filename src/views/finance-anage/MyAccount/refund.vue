      ...
      <Card>
        <div class="w_query">
          <Row>
            ...
            <Col span="6" :style="{marginBottom:'20px'}">
                对应结算退款单号：<Input v-model="query.NO" placeholder="请输入对应结算单号" style="width: 150px" />
            </Col>
            <Col span="6" :style="{marginBottom:'20px'}">
...
export default {
    ...
    methods: {
        ...
        getList () {
            this.columnsData = [];
            try {
                this.$http.get(`${this.fm}/finance/account/myListrefundBill`, {
                    params: {
                        marketplaceId: this.path.marketplaceId,
                        merchantId: this.path.merchantId,
                        ...
                        status: this.query.state === '全部' ? '' : this.query.state,
                    ...
                    if (data.return_code === 200) {
                        ...
                        dataList.map((item, index) => {
                            this.columnsData.push({
                                ...
                                settlenum: item.refundBills[0].outRefundNo ? item.refundBills[0].outRefundNo : '',
